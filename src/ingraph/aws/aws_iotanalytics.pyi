...
class Datastore:
    ...
    class FileFormatConfiguration:
        def __init__(
            self,
            *,
            JsonConfiguration: "Datastore.JsonConfiguration" = ...,
            ParquetConfiguration: "Datastore.ParquetConfiguration" = ...
        ): ...
    class JsonConfiguration:
        def __init__(self) -> None: ...
    class ParquetConfiguration:
        def __init__(self, *, SchemaDefinition: "Datastore.SchemaDefinition" = ...): ...
    class RetentionPeriod:
        def __init__(self, *, NumberOfDays: int = ..., Unlimited: bool = ...): ...
    class SchemaDefinition:
        def __init__(self, *, Columns: List["Datastore.Column"] = ...): ...
    class ServiceManagedS3:
        def __init__(self) -> None: ...
