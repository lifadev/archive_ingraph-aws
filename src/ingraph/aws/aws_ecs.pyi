...
class Service:
    ...
    class DeploymentCircuitBreaker:
        def __init__(self, *, Enable: bool, Rollback: bool): ...
    class DeploymentConfiguration:
        def __init__(
            self,
            *,
            DeploymentCircuitBreaker: "Service.DeploymentCircuitBreaker" = ...,
            MaximumPercent: int = ...,
...
class TaskDefinition:
    ...
    class AuthorizationConfig:
        def __init__(self, *, AccessPointId: str = ..., IAM: str = ...): ...
    ...
    class EFSVolumeConfiguration:
        def __init__(
            ...
            *,
            FilesystemId: str,
            AuthorizationConfig: "TaskDefinition.AuthorizationConfig" = ...,
            RootDirectory: str = ...,
    ...
    class Volume:
        def __init__(
            ...
            *,
            ...
            EFSVolumeConfiguration: "TaskDefinition.EFSVolumeConfiguration" = ...,
